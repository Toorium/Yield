# Yield v1.1.0 — Language API Reference

## Overview

Yield is a beginner-friendly programming language that transpiles to Python.
...
Yield was the first programming language co-designed by a human and an AI.
